<section class="box box-about bg-cover" style="background-image: url({{asset('images-UI/x11-e12.jpg')}})">
    <div class="container">
        ...
        <div class="description-detail wow fadeInUp animated color-white text-center"><p style="text-align: center;"><strong>VNVHOME</strong>&nbsp;là <strong><em>công ty&nbsp;thiết kế, thi công Nội thất &amp; Kiến trúc&nbsp;hàng đầu tại&nbsp;Việt Nam</em></strong> với sự tin tưởng của hàng ngàn khách hàng khắp mọi nơi trên cả nước.</p>
            ...
            <p style="text-align: center;">VNVHOME Là đơn vị duy nhất có thể cung cấp đầy đủ trọn gói các sản phẩm dịch vụ từ thiết kế, thi công Nội thất đến Xây mới, cải tạo, trang trí…</p>

            <p style="text-align: center;">Ngoài ra, chúng tôi còn mang đến các sản phẩm <strong><em>Nội thất cao cấp</em></strong>… với những&nbsp;bản thiết kế chi tiết đến hoàn hảo.</p>
        </div>
        <div class="box-info">
            <div class="row">
                <div class="col-xs-12 col-sm-4">
                    <div class="item text-center item-0 wow animated fadeInLeft">
                        ...
                        <h4 class="title"><a href="javascript:void(0)" title="Tầm nhìn">Tầm nhìn</a></h4>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-4">
                    <div class="item text-center item-1 wow animated fadeInUp">
                        ...
                        <h4 class="title"><a href="javascript:void(0)" title="Lịch sử">Lịch sử</a></h4>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-4">
                    <div class="item text-center item-2 wow animated fadeInRight">
                        ...
                        <h4 class="title"><a href="javascript:void(0)" title="Sứ mệnh">Sứ mệnh</a></h4>
                    </div>
                </div>
            </div>
        </div>
